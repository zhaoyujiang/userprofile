...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserProfile.regularTime'
        db.add_column('oaprofile_userprofile', 'regularTime',
                      self.gf('django.db.models.fields.DateField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'UserProfile.is_regular'
        db.add_column('oaprofile_userprofile', 'is_regular',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UserProfile.regularTime'
        db.delete_column('oaprofile_userprofile', 'regularTime')

        # Deleting field 'UserProfile.is_regular'
        db.delete_column('oaprofile_userprofile', 'is_regular')
