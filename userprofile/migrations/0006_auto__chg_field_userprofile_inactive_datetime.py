...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'UserProfile.inactive_datetime'
        db.alter_column('oaprofile_userprofile', 'inactive_datetime', self.gf('django.db.models.fields.DateField')(null=True))


    def backwards(self, orm):
        
        # Changing field 'UserProfile.inactive_datetime'
        db.alter_column('oaprofile_userprofile', 'inactive_datetime', self.gf('django.db.models.fields.DateTimeField')(null=True))
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 3, 5, 15, 23, 33, 102782)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 3, 5, 15, 23, 33, 102686)'}),
        ...
        'oaprofile.userprofile': {
            ...
            'inactive_datetime': ('django.db.models.fields.DateField', [], {'null': 'True', 'blank': 'True'}),
